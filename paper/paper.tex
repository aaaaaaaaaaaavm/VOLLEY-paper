...
\begin{equation}
K_t = 10.54~\mathrm{N\,per\,kA/m},\qquad \text{ripple } \pm1.01\%\ (6\text{th harmonic}),
\end{equation}
...
The column that does move is deployer mass per satellite, by a factor of thirty. At 3U the machine spends \textbf{7.04~kg of deployer per customer}, which loses to a cold-gas propulsion module delivering the same 16.0~m/s at 0.5--1.2~kg by roughly a factor of eight. At PocketQube it spends \textbf{0.24~kg} and wins by two to five. The comparison inverts entirely on payload class, and on no machine parameter at all: not the thrust constant, not the stroke, not the sheet current.
