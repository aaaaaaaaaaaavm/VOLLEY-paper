...
| File | What | Pages |
|---|---|---|
| `print/Adityavardhan_Mishra_VOLLEY_IEEE_2026_A4_Print.pdf` | the manuscript, A4, to carry | 17 |
| `print/Adityavardhan_Mishra_VOLLEY_IEEE_2026_Letter.pdf` | the same manuscript, US Letter, the submission format | 17 |
...
| Acceleration | 10.07 g of a 25 g cap | 5 | M | `motor_results.shot.a_g` | live |
...
| Defect register | 132 entries, 53 live | — | `tools/register_status.py`, gate-checked |
...
| Fonts | all four PDFs: every font embedded, **zero Type 3 bitmap fonts** — `pdffonts`. `lmodern` was added to both handout sources after the first build embedded an 8 pt bitmap typewriter face |
